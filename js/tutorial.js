...
function onLobby(){
  ...
  if(step===0){
    ...
    step=5;
    say('<b>¡Ese es tu guerrero!</b> Ya es tuyo.<br>Ahora dale <b>JUGAR</b>: se trata de <b>SOBREVIVIR</b> — la ronda dura hasta que quede UNO en pie y los caídos pierden 1 ♥. ¡Sé el último!','#btn-ranked');
  }
}
